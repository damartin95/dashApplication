...
layout = dbc.Container([
    ...
    html.Div(
        children=[
            dbc.Button('Submit', id='submit_user1', n_clicks=0,  #remove n_clicks=0!
            color='secondary'),
            ],
        style={"display": "flex", "justifyContent": "center"}),
...
def add_friend(switches_input):
    ...
    if len(switches_input) > 0:
        ...
        add_friend_form = html.Div(children=[
            ...
            html.Div(
                children=[
                    dbc.Button('Submit', id='submit_user2', n_clicks=0,  #remove n_clicks=0!
                    color='secondary'),
                    ],
                style={"display": "flex", "justifyContent": "center"}),
